def set_up_datasets(args):
    ...
    elif args.dataset == 'pinpp':
        args.num_class = 900
        if args.deepemd == 'fcn':
            from Models.dataloader.pinpp.fcn.pinpp import PINPP as Dataset
        elif args.deepemd == 'sampling':
            from Models.dataloader.pinpp.sampling.pinpp import PINPP as Dataset
        elif args.deepemd == 'grid':
            from Models.dataloader.pinpp.grid.pinpp import PINPP as Dataset
    else:
